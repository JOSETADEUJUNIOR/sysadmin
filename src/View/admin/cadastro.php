      ...
      <div class="card-body">
        ...
        <form id="form_cadastro" method="post" action="cadastro.php">
          <div class="input-group mb-3">
            <input name="nome" id="nome" type="text" class="form-control obg" placeholder="Nome">
          ...
          <div class="input-group mb-3">
            <input type="email" name="login" id="login" onchange="ValidarEmailCadastrado(this.value)" class="form-control obg" placeholder="E-mail">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3">
            <input type="password" name="resenha" id="resenha" class="form-control obg" placeholder="Confirme a senha">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"></span>
              </div>
          ...
          <div class="input-group mb-3">
            <input type="phone" name="telefone" id="telefone" class="form-control obg" placeholder="Telefone">
            <div class="input-group-append">
              <div class="input-group-text">
