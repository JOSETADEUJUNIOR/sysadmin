<div class="modal fade" id="modalExcluirItemVenda">
        <div class="modal-dialog">
          <div class="modal-content bg-danger">
            ...
            <input type="hidden" id="ExcluirVendaID" name="ExcluirVendaID">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button name="btnExcluir" class="btn btn-outline-light" onclick="return ExcluirItemVenda()">Excluir registro</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
