                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Consultar chamado</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Consulta chamado</h3>
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn bg-gradient-info btn-sm">Pesquisar</button>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" class="btn bg-gradient-warning btn-xs">Atender</a>
                                                        <a href="#" class="btn bg-gradient-success btn-xs">Finalizar</a>
                                                    </td>
                                                </tr>
